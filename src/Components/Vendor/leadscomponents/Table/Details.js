...
const Details = ({setCurrentSection,requesteduserDetail,selectedRequest,priceDetails}) => {

    console.log(selectedRequest , 'this is imp');
  ...
  useEffect(() => {
    ...
    const userData = requesteduserDetail ? requesteduserDetail?.data[0] :""
    const data=selectedRequest? JSON.parse(selectedRequest?.data):""
    


    const xyz=priceDetails ? priceDetails?.price_detail : ""
    ...
    return (
        <div className="details">
            ...
            <div className="detailscontainer">
                    ...
                    {/* <Card className={`${classes.root} view-detail-card`} variant="outlined">
                        <CardContent>
                            <div className="cardcontent1">
                                <PersonIcon/>
                                <h4>{userData ? userData?.first_name :"___"}</h4>
                            </div>
                            <div className="cardcontent1">
                                <ApartmentIcon/>
                                <h4>{userData ?userData?.address:"___"}</h4>
                            </div>
                            <div className="cardcontent1">
                                <EmailIcon/>
                                <h4>{userData ? userData?.email: "___"}</h4>
                            </div>
                            <div className="cardcontent1">
                                <PhoneIcon/>
                                <h4>{userData ? userData?.phone_no :"___"}</h4>
                            </div>
                            <div className="cardcontent1">
                                <WhatsAppIcon/>
                                <h4>{userData ? userData?.whatsapp_no: "___"}</h4>
                            </div>
                            <div className="cardcontent1">
                                <LocationOnOutlinedIcon/>
                               <h4>{userData ? userData?.city: "___"} , {userData ? userData?.state :"___"}</h4>
                            </div>
                        </CardContent>
                    </ Card> */}
                </div>
                    ...
                    {/* <Card className={`${classes.root} view-detail-card`} variant="outlined">
                        <CardContent>
                            <div className="cardcontent">
                                ...
                                <h4 className="contentvalue">{data ? data?.brand ?data?.brand :"":""}{selectedRequest ?selectedRequest?.type :"___"}</h4>
                            </div>
                            <div className="cardcontent">
                                <h4 className="contentkey">Placed on:</h4>
                                <h4 className="contentvalue">{selectedRequest ? selectedRequest?.placed_on.toString().substring(0,10):"___"}</h4>
                            </div>
                            {
                                data?.materials ? 
                                // console.log(data, "re")
                            ...
                            <div className="cardcontent">
                                ...
                                <h4 className="contentvalue">{selectedRequest ? selectedRequest?.quantity:"___"} units</h4>
                            </div>
                            <div className="cardcontent">
                            ...
                            <div className="cardcontent">
                                ...
                                <div><Status type={selectedRequest ? selectedRequest?.product_status:"___"} style={{width:"100%"}}/></div>
                            </div>
                            {(selectedRequest?.type==="Cement" || selectedRequest?.type==="RMC" || selectedRequest?.type==="Paint & Putty") && 
                                <div className="cardcontent">
                ...
                <div className="detailscontent">
                    <h3 style={{color: "#FFB600",fontWeight: "550"}}>Price Summary</h3>
                    ...
                    {/* <Card className={`${classes.root} view-detail-card`} variant="outlined">
                        <CardContent>
                            <div className="cardcontent">
                                <h4 className="contentkey">Price</h4>
                                <h4 className="contentvalue">{prices ? prices?.price:"___"}</h4>
                            </div>
                            <div className="cardcontent">
                                <h4 className="contentkey">+ GST</h4>
                                <h4 className="contentvalue">{prices ? prices?.gst:"___"}</h4>
                            </div>
                            <div className="cardcontent">
                                <h4 className="contentkey">+ Delivery Charges</h4>
                                <h4 className="contentvalue">{prices ? prices?.deliverycharges:"___"}</h4>
                            </div>
                            <div className="cardcontent">
                                <h4 className="contentkey">Extra Charges</h4>
                                <h4 className="contentvalue">{prices ? prices?.extracharges:"___"}</h4>
                            </div>
                            <hr style={{ width:"100%",borderColor:" #fff" ,backgroundColor: "#fff",marginTop:"2rem"}}></hr>
                            <div className="cardcontent">
                                <h4 className="contentkey" style={{fontSize:"1.2rem",fontWeight:"700"}}>Grand Total</h4>
