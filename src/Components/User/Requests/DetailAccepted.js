...
const DetailAccepted = ({setCurrentSection,selectedTableItem,requestedVendorDetails}) => {
...
const DeliveryDate = selectedTableItem?.deliver_by!=="0000-00-00 00:00:00" ? selectedTableItem?.deliver_by.toString().substring(0,10):JSON.parse(selectedTableItem?.data)?.startDate ? JSON.parse(selectedTableItem?.data)?.startDate?.slice(0,10) + " to " +JSON.parse(selectedTableItem?.data)?.endDate?.slice(0,10) :"___" 
                    ...
                    {/* <Card className={`${classes.root} view-detail-card`}variant="outlined">
                        <CardContent>
                            <div className="card-content-temp">
                                <PersonIcon />
                                <h4 className="card-content-temp-value">{requestedVendorDetails?.first_name}</h4>
                            </div>
                            <div className="card-content-temp">
                                <ApartmentIcon />
                                <h4 className="card-content-temp-value">{requestedVendorDetails?.address}</h4>
                            </div>
                            <div className="card-content-temp">
                                <EmailIcon />
                                <h4 className="card-content-temp-value">{requestedVendorDetails?.email}</h4>
                            </div>
                            <div className="card-content-temp">
                                <PhoneIcon />
                                <h4 className="card-content-temp-value">{requestedVendorDetails?.phone_no}</h4>
                            </div>
                            <div className="card-content-temp">
                                <WhatsAppIcon />
                                <h4 className="card-content-temp-value">{requestedVendorDetails?.whatsapp_no}</h4>
                            </div>
                            <div className="card-content-temp">
                                <LocationOnOutlinedIcon />
                                <h4 className="card-content-temp-value">{requestedVendorDetails?.city},{requestedVendorDetails?.state}</h4>
                            </div>
                        </CardContent>
                    </ Card> */}
                            ...
                            </div>
   {
                            ...
                            <div className="cardcontent">
                                ...
                                <h4 className="contentvalue"><Status type="acceptedPitch"/></h4>
                            </div>
                            {(selectedTableItem?.type==="Cement" || selectedTableItem?.type==="RMC" || selectedTableItem?.type==="Paint & Putty") && 
                                <div className="cardcontent">
