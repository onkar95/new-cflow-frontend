...
import "./Styles.css"
function Admixture({setNewRequest,setOpenSaved,quantity,setQuantity,newRequest,setModalOpen,setData}) {
    const [userId,setUserId] = useState(JSON.parse(localStorage.getItem('profile'))?.data?.id)
    const history = useHistory()
  const types = ["Water Reducing Admixtures" , "Retarding Admixtures" , "Accelerating Admixtures" , "Air Entraining Concrete Admixture" , "Pozzolanic Admixtures" , " Damp-proofing Admixtures","Gas forming Admixtures" , "Air detraining Admixtures" , "Alkali Aggregate Expansion Preventing Admixtures" , "Anti-washout Admixtures" , "Grouting Admixtures" , "Corrosion Preventing Admixtures" , "Bonding Admixtures" , "Fungicidal, Germicidal, Insecticidal Admixtures" , "Coloring Admixtures"]
  const brands = ["The Dow Chemical Company","BASF SE","Sika AG" , "WR Grace & Co" , "Pidilite Industries" , "RPM International" , "CICO Technologies Ltd" , "Ashland Inc","Chryso SAS","Fosroc International"]
