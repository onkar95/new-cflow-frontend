...
function Flooring({setNewRequest,setOpenSaved,quantity,setQuantity,newRequest,setModalOpen,setData}) {
   const [userId,setUserId] = useState(JSON.parse(localStorage.getItem('profile'))?.data?.id)
  const history = useHistory()

  const types = ["Epoxy Floor", "Floor hardner" , "Resin & cementitious flooring" , "Primers" , "polyurethane flooring"]
  
  const brands = ["BOSS","Perma","Dr.Fixit","Ethios","Softex","WEICON","Ranspoly","Loctite","STP Limited","McCoy","Eurron"]
