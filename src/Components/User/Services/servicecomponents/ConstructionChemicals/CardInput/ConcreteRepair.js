...
import "./Styles.css"
function ConcreteRepair({setNewRequest,setOpenSaved,quantity,setQuantity,newRequest,setModalOpen,setData}) {
  const [userId,setUserId] = useState(JSON.parse(localStorage.getItem('profile'))?.data?.id)
  const history = useHistory()
  const types =["Cementitious repair motars" , "Cementitious micro concrete" , "Epoxy resing based concrete" , "Epoxy resin based motars" , "Epoxy and PU injection grouts" , "Structural reinforcement protection" , "Fibre reinforced polymers"]
  const brands = ["Forsoc" , "Sika" , "Simcrete" , "Renderoc" , "Asian Paints" , "CRRS"] 
